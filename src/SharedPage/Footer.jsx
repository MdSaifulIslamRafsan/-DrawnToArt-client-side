...
const Footer = () => {
  return (
    <footer className="mt-8 bg-cyan-950 pt-9">
      <div className="mx-auto w-[95%] lg:w-10/12 max-w-[1440px] ">
        <div className="flex flex-col justify-between lg:flex-row">
          <div className="lg:w-1/3">
            ...
            Welcome to DrawnToArt, your online haven for painters and drawers alike. Immerse yourself in a world of creativity, tutorials, and community. Let's make art together
            </p>
            <div className="mt-[18px] flex gap-4">
              <a className="hover:scale-110" target="_blank" href="#">
                <img
                  ...
                  src="https://i.ibb.co/x36k9L9/facebook-new.png"
                />
              </a>
              <a className="hover:scale-110" target="_blank" href="/">
                <img
                  ...
                  data-nimg={1}
                  style={{ color: "transparent" }}
                  src="https://i.ibb.co/9sH9Jwn/linkedin-2.png"
                />
              </a>
              <a className="hover:scale-110" target="_blank" href="/">
                <img
                  ...
                  data-nimg={1}
                  style={{ color: "transparent" }}
                  src="https://i.ibb.co/T8TXHHp/instagram-new.png"
                />
              </a>
              <a className="hover:scale-110" target="_blank" href="">
                <img
                  ...
                  data-nimg={1}
                  style={{ color: "transparent" }}
                  src="https://i.ibb.co/WK9S8kN/twitter.png"
                />
              </a>
              <a
              ...
              >
                <img
                  ...
                  data-nimg={1}
                  style={{ color: "transparent" }}
                  src="https://i.ibb.co/Q81SvHd/facebook-messenger-v2.png"
                />
              </a>
            </div>
          </div>
          ...
          <div className="mt-6 flex lg:w-1/3 flex-col justify-between text-white sm:flex-row md:mt-0">
            <div className="">
              ...
              <ul className="space-y-3 my-3">
                ...
                <li>
                  <Link to={"/AllArt&craftItems"}>All Art & craft Items</Link>
                </li>
                <li>
                  <Link to={"/AddCraftItem"}>Add Craft Item</Link>
                </li>
                <li>
                  <Link to={"MyArt&CraftList"}>My Art & Craft List</Link>
                </li>
              </ul>
            </div>
        ...
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[10px] font-normal text-white md:text-[12px]">
            © Copyright 2024 , All Rights Reserved by DrawnToArt . PVT. LTD
          </p>
        </div>
      </div>
    </footer>
